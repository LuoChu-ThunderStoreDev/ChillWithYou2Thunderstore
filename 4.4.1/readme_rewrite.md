...
[![Chill with You](https://github.com/Small-tailqwq/RealTimeWeatherMod/blob/v4.4.1/header_schinese.jpg)](https://store.steampowered.com/app/3548580/)
...
3. 环境映射规则：
   白天：非恶劣天气且时间为日出后
   黄昏：非恶劣天气且时间为日出前后30分钟
   夜晚：时间为日落后（无论是否非恶劣天气，夜晚不能是多云，就必须是夜晚）
   多云：恶劣天气（雨雪等）且时间为日出前
4. 恶劣天气名单：
...
### v4.2.1
- 添加了一个调试模式，开始尝试调整调整天气ID查看对应天气切换效果（什么？你现在才开始测试？！）
- 然 Gemini 别刷版本号了
...
详见 [LICENSE](https://github.com/Small-tailqwq/RealTimeWeatherMod/blob/v4.4.1/LICENSE) 文件。
