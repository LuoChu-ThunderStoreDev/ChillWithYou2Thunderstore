...
[![Chill with You](https://raw.githubusercontent.com/Small-tailqwq/iGPUSaviorMod/v1.8.1/img/header_schinese.jpg)](https://store.steampowered.com/app/3548580/)
...
![Steam 论坛演示](https://raw.githubusercontent.com/Small-tailqwq/iGPUSaviorMod/v1.8.1/img/ptt4.png)
...
![优化前内存占用](https://raw.githubusercontent.com/Small-tailqwq/iGPUSaviorMod/v1.8.1/img/mmr1.png)
<p align="center"><i>优化前：内存占用 1,134.8 MB</i></p>

![优化后内存占用](https://raw.githubusercontent.com/Small-tailqwq/iGPUSaviorMod/v1.8.1/img/mmr2.png)
...
![优化前 GPU 占用](https://raw.githubusercontent.com/Small-tailqwq/iGPUSaviorMod/v1.8.1/img/ptt3.png)
<p align="center"><i>优化前：3D 占用率 43%，持续高负载</i></p>

![优化后 GPU 占用](https://raw.githubusercontent.com/Small-tailqwq/iGPUSaviorMod/v1.8.1/img/ptt2.png)
...
### 土豆模式
优化效果有限，画面会变模糊。主要作用是在后台不可见时，将画面变成马赛克模式以减少显卡占用，聚焦或置顶时不自动应用。
...
详见 [LICENSE](https://github.com/Small-tailqwq/iGPUSaviorMod/blob/v1.8.1/LICENSE) 文件。
